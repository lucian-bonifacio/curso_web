...
console.log(convertToString(569))
...
texto = 'lucian Bonifácio'

const qtdCaracter = texto => {
  return texto.length
}

console.log(qtdCaracter(texto))
...
textoQuestaoTres = "CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO"

const minus = texto => {
  return texto.toLowerCase()
}

console.log(minus(textoQuestaoTres))
...
const indice = (caracter, string) => {
  return string.indexOf(caracter)
}

console.log(indice('l', 'lucian'))
...
lista = [1, 2, 3, 4, 5, 6, 7]
const isReal = function (item, array) {
  return array.includes(item)
}

console.log(isReal(10, lista))
...
const doisArrays = (array1, array2) => {
  return array1.concat(array2)
}
const outraLista = ['um', 'dois', 'tres', 'quatro', 'cinco', 'seis', 'sete']

console.log(doisArrays(lista, outraLista))
...
console.log(removeItemArray(lista))
