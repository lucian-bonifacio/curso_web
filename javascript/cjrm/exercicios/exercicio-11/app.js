...
// console.log(heinz)
/*
Aconteceu porque a let = heinz foi criada dentro de uma função, ou seja, ela só pode ser acessada dentro do bloco de cógigo que foi criada.

Aula de escopo de bloco.
