...
const B99Pattern = /[A-Z1-9]{3}/ 
const B99message = 'E o Terry Crews faz tudo, inclusive tocar a abertura de B99 na flauta'
const resultB99 = B99Pattern.test(B99message)
...
form.addEventListener('submit', event => {
  ...
  const inputValue = event.target.input
  const isAMatch = inputRegex.test(inputValue.value)

  if(isAMatch){
    console.log('O valor inserido no input é válido =)')
  } else {
    console.log('O valor invalido =(')
  }
