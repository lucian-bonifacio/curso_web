...
const oiZeca = function (cahorros) {
  return cahorros.name === 'Zequinha'
}

console.log(dogs.find(oiZeca))

console.log(dogs.find(element => element.name === 'Zequinha'))

// console.log(dogs.find((element) => {
//   console.log(element)
// }))

/* lista = [1, 2, 3]
novalista = lista.find((element) => {
  return element === 1
})
...
secondaryTitle = document.querySelectorAll('h2.secondary-title')
